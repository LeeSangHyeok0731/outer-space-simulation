---
name: review-pr
description: 'Collect outer-space-simulation GitHub PR review comments, assess each comment against project rules, apply valid fixes when safe, optionally commit and push fixes, and post Korean replies with gh api. Use only when the user explicitly asks to address PR review comments or reply to review comments.'
...
Do not include unrelated changes or gitignored harness artifacts.
